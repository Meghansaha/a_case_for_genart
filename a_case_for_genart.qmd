...
::: notes
On Maternity leave:<br> - daily gen art challenge, Genuary.<br> - One of the prompts - Maximalism <br> - Wanted finger-like things from the top and bottom of the page<br> - This a problem of iteration because i want lots of the same thing w/ variations<br> <click><br><br> In a similar situation back at work -<br> - Had A lot of imaging data to reconcile from vendors all at once. <br> - I Wanted to make cleaner/smoother workflow of doing multiple actions to multiple dfs in one go <br> - Also a problem of iteration
:::
