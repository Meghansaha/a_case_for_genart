...
-   If you know how to make visuals in R or Python, you're already so close to making generative art...
:::
...
::: notes
Now There were some more abstract examples...<br>
- like mathematical/logical reasoning<br>
- yeahhh... Imagine how PISSED I was when I found out math was involved to make art..
- But the truth is that Art can require you to know about patterns, numeric sequences, and general logic.. that logic is what makes it possible to go from a grid of points like this...
:::
...
-   funny enough, in this tweet i made last year
-   I was Talking with others about how I wanted to create an art package
-   but i was admitting that I was afraid to
-   because I didn't having a formal developer background, and didn't feel smart enough
...
-   Now, I have tons of examples but I'll only focus on three main concepts..
-   How this will work:
-   Present the concept, then give an example of its use in an art scenario and data science scenario
:::
...
- Isolation looked like figuring out the data. What are the numbers that will plot the shape I want<br> 
...
<center>![](images/ex1snip_art.png){width="100%"}</center>
:::
...
<center>![](images/ex1snip_ds.png){width="100%"}</center>
:::
:::

::: notes
Solution is the same in both scenarios:<br>
- Once you've isolated the problem, the challenge is to just successfully introduce iteration<br>

-   I will point out that my preferred method is using purrr functions in R.
-   But whether you're using Purrr in R, or for loops in Python, 
-   all that matters is that you are doing what you need to, in a way that works for you
<br>
...
::: columns
::: {.column width="50%"}
-   Learning and honing in on development skills can take you to new levels✨. <br><br>
...
::: notes
Development is HIGHLY desirable in Data Science: <br>
-   because it allows you to take more advantage of the "open-source" paradigm we have within our community by creating programs for yourself, internally for your organization, and others.
:::
...
art scenario:<br>
-   I wanted to reduce code bloat, so just stop copy and pasting things over and over

data science scenario:<br>
-   At work, a fx stopped working in our internal pacakge, so I needed to make a new one
:::
...
<center>![](images/dev_snip_art.png){width="100%"}</center>
...
<center>![](images/dev_snip_ds.png){width="100%"}</center>
:::
:::

::: notes
-   No matter the scenario, the approach is the same
-   You have to go through a iterative process of debugging and development
...
::: notes
"So the solution is simple, just use..."<br><br>
-   Whether you are doing art or data science, or using R or python, the goal of creating functions are the same <br>
-   We just wish to do a specific task.. <br>
-   in an isolated environment..<br>
-   for a consistent output or result.<br>
...
- maybe for art: explaining art methods, collaborating w/ others...<br>
...
<br> Create a reprex with the [`reprex` package](https://reprex.tidyverse.org/)
...
-   Perfect opportunity for me to practice making reprexes (Reproducible Examples)<br><br>
...
- It's a good idea to stop and ask yourself if you are missing any external contextual info
- and if so, step away from the console and talk to your SME
:::
...
-   Managers and leads at work, could you make room in your team's scheduling to allow for personal development that looks like this? -> click next
