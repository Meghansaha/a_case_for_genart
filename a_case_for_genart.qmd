...
<span style="float:right">@KazeKomboArt</span>
:::
...
::: notes
Now this is vague and general, and yes. that's on Aim
...
- I mean, Posit, Jenny, Hadley, ya'll got my e-mail, I can help with the art workshop new year if ya'll want, I'm just saying, but for right now
...
::: notes
- Art is why I created my first "real" function ever in R.
- besides simply printing "Hello World"
- As you make more art - want more complicated pieces 
...
-   Whether you use base control flows like for-loops, whiles, and repeats, or you've fully adopted tidyverse's purrr ecosystem in R
...
- daily gen art challenge, Genuary.<br> 
- One of the prompts - Maximalism <br>
- Wanted finger-like things from the top and bottom of the page<br>
- This a problem of iteration because i want lots of the same thing w/ variations<br>
<click><br><br>
In a similar situation back at work -<br>
- Had A lot of imaging data to reconcile from vendors all at once. <br>
- I Wanted to make cleaner/smoother workflow of doing multiple actions to multiple dfs in one go <br>
- Also a problem of iteration
:::
...
::: notes
In art: <br>
- it's a bit diff...the first challenge has an initial step of creating the data <br>
- People always ask me how this process goes, especially because I hate math...<br>
- keep trying until the plot shows what you're going for  <br>
- once you get one shape correctly with colors and aesthetics - you've isolated the problem!
<br>
In Data Science: <br>
- You already have the data.. (hopefully it's cleaned and accurate) <br>
- Isolate the problem by doing what you want for at least one data frame <br>
- Keep debugging until the final output is correct and operating as intended
:::
...
lst_labelled <- 
  imap(lst_vendors_dfs, ~set_derived_variable_labels(
...
::: notes
In art: 
- Once you've isolated the problem, the challenge into to successfully introduce iteration
- My preferred method is using purrr in R
<br>
This process is the same in DS <br>
- but know that I did NOT understand how to use purrr functions <br>
- confidently UNTIL i needed it for art, even after trying for a good amount of time <br>
- Doing it with art felt more tangible with my brain when no stakes were on the table
<br>
...
::: notes
For art<br>
-   programming/developing skills, can really put you on another level of complexity and skill<br>
-   Development is HIGHLY desirable in DS because <br>
-   it allows you to take more advantage of the "open-source" paradigm by creating programs for your organization and others in the community.
:::
...
::: notes
Maternity leave (gen art scenario):<br>
- Was working on the artpack package<br>
-   Realized I was always using a certain process over and over and over.<br>
-   I realized it would be helpful to create a function<br>
-   to complete the process in one line to reduce some code bloat
<br>
Back at work (Data Sci scenario):<br>
-   We already had an existing fx created in an internal package
-   that had stopped working as intended
-   So I needed to burn it down and create a new and improved function
...
::: notes
On Maternity Leave (gen art scenario):<br>
-   I needed to ask people for help with package development stuff for artpack. <br>
-   (Big thank you to Daniel Sjoberg - creator of many awesome packages like gtsummary and ggsurvfit)<br>
- While Daniel was gracious enough to let me bother him with questions <br>
- I realized that I needed to translate what I was doing when asking for help <br>

Back at work (data sci scenario): <br>
- People were requesting data <br>
- but the people requesting the data didn't know what I needed to complete <br>

Comparing these scenarios are interesting b/c<br>
-   The scenarios are flipped but similar.<br>
- In the art scenario, I am the SME <br>
- In the Data Science Scenario, I am not the SME <br>

These scenarios:<br>
-   Required communicating in different ways, but they had the need of getting everyone involved on the same page.
:::
...
::: notes
gen art - required thinking about what I'm doing on a functional level w/o the context of art and introducing people into the problem that way <br>
<br>
data sci - required accessing the situation in R, IDing what external pieces of info I was missing and then working with the SME to help them, help me so we could get on the same page.
:::
