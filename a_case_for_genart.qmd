...
::: notes
-   Finally, we feed this dataframe into the set ggplot fxs at the bottom to create the plot
...
-   First I decide to make the sky in the background, so that's first
...
-   I was Talking with others about how I wanted to create a package
-   because i've been doing more art, and felt there was need
...
::: notes
-   Whether it's for art or data science, or in R or Python, the approach is the same
...
-   Whether you are doing art or data science, in R or python, the goal of creating functions are the same <br>
