...
- This a problem of iteration because i want lots of the same thing w/ variations<br> <click><br><br>
In a similar situation back at work:-<br>
- Had A lot of vendor data to reconcile all at once.<br> 
- I Wanted to make cleaner/smoother workflow of doing multiple things to multiple dfs in one go <br>
...
-   Isolate the problem....
- how tf do we make a finger-like shape in the first place??
...
-   Isolate the problem....
-   Can this work at least once?<br>
...
::: notes
In art: <br> -
-   first challenge has an initial step of creating the data <br> 
-   for me, this is trial and error
People always ask me how this process goes, especially because I hate math...<br> - keep trying until the plot shows what you're going for <br> - once you get one shape correctly with colors and aesthetics - you've isolated the problem! <br> In Data Science: <br> - You already have the data.. (hopefully it's cleaned and accurate) <br> - Isolate the problem by doing what you want for at least one data frame <br> - Keep debugging until the final output is correct and operating as intended
:::
...
::: notes
In art: - Once you've isolated the problem, the challenge into to successfully introduce iteration - My preferred method is using purrr in R <br> This process is the same in DS <br> - but know that I did NOT understand how to use purrr functions <br> - confidently UNTIL i needed it for art, even after trying for a good amount of time <br> - Doing it with art felt more tangible with my brain when no stakes were on the table <br>
...
-   Identify what I am functionally trying to do without the context of the art...
...
-   Identify what context or details I am missing...
...
-   Create a reprex with the [`reprex` package](https://reprex.tidyverse.org/) (R) or the [`reprexpy` library](https://reprexpy.readthedocs.io/en/latest/) (Python)...
...
-   Translate what you are doing in R or Python to the Subject Matter Expert...
